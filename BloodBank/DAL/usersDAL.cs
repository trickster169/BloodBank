    ...
    class userDAL
    {
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                String sql = "INSERT INTO Users(username, email, password, full_name, contact, address, added_date) VALUES (@username, @email, @password, @full_name, @contact, @address, @added_date)";
        ...
        public bool Update(userBLL u)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE Users SET username=@username, email=@email, password=@password, full_name=@full_name, contact=@contact, address=@address, added_date=@added_date WHERE user_id=@user_id";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM Users WHERE user_id LIKE '%" + keywords + "%' OR full_name LIKE '%" + keywords + "%' OR address LIKE '%" + keywords + "%'";
